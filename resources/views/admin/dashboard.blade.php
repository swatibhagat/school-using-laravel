...
<head>
  ...
  <title>Steadfast | Dashboard</title>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset("/resources/assets/admin-lte/dist/css/AdminLTE.min.css") }}">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset("/resources/assets/admin-lte/dist/img/user4-128x128.jpg") }}" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset("/resources/assets/admin-lte/dist/img/user3-128x128.jpg") }}" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset("/resources/assets/admin-lte/dist/img/user2-160x160.jpg") }}" alt="user image" class="offline">
...
<script src="{{ asset("/resources/assets/admin-lte/plugins/morris/morris.min.js") }}"></script>
<!-- Sparkline -->
