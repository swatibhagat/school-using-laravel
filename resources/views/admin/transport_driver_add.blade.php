		...
		<div class="row">			 
			...
			<form class="form-horizontal" method="post" action="create" >					 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="driver_name" class="form-control" type="text" placeholder="Enter Name of driver" required>
					 
                  </div>
                </div><div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">License No.<span>*<span></label>
                  <div class="col-sm-9">
                     <input name="license_no" class="form-control" type="text" placeholder="Enter License No. " required>
