			...
			<div class="">				 
					<div class="box-body">
						<table id="memTable" class="table table-bordered table-striped">
							...
							<tr>								
								<td>{{$i++}}</td>
								<td>{{$emp_dept->dept_name}}</td>							
								
								<td><a class="icon-pencil" title="" href="{{url("/employee_dept/edit/$emp_dept->dept_id")}}"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
								 
								<a class="icon-cross2" onclick="return confirmDel()" title="" href="{{url("/employee_dept/delete/$emp_dept->dept_id")}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
							</tr>  
							@endforeach	
							@endif						
							</tbody> 
