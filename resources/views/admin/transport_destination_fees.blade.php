  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="row">			 
			...
			@endif	
			<div class="box-body">
				<a href="{{url("destination_fee/add")}}">
					...
					<div class="box-body">
						<table id="memTable" class="table table-bordered table-striped">
							...
							@endif	
								...
								<td>{{$fees->amount}}</td>
								<td>{{$fees->fee_type}}</td>
								<td><a class="icon-pencil" title="" href="{{url("/destination_fee/edit/$fees->f_id")}}"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
								 
								<a class="icon-cross2" onclick="return confirmDel()" title="" href="{{url("/destination_fee/delete/$fees->f_id")}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
							</tr>  
							@endforeach	
							@endif						
							</tbody> 
