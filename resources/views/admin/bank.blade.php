  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="row">			 
			...
			<div class="box-body">
				<a href="{{url("bank/add")}}">
					<button type="button" class="btn btn-info pull-right -background-color">Bank Name Add</button>
				</a>
			</div>		
			<div class="">				 
					<div class="box-body">
						<table id="memTable" class="table table-bordered table-striped">
							...
							<tr>								
								...
								<td><a class="icon-cross2" onclick="return confirmDel()" title="" href="{{url("/bank/delete/$bank->bank_id")}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
							</tr>  
							@endforeach	
							@endif 				
							</tbody> 
