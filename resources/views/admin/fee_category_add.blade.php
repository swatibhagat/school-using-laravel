		...
		<div class="row">			 
			...
			<form class="form-horizontal" method="post" action="create" >					 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="fee_cat" class="form-control" type="text" placeholder="Enter Fee Category" required>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="fee_receipt" class="form-control" type="text" placeholder="Enter Receipt No. Prefix" required>
					 
                  </div>
                </div><div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">Description <span>*<span></label>
                  <div class="col-sm-9">
                     <textarea name="desc" class="form-control" type="text" placeholder="Enter Description" required></textarea>
