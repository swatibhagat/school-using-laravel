		...
		<div class="row">			 
			...
			<form class="form-horizontal" method="post" action="create" >					 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <!--input name="vehicle_no" class="form-control" type="text" placeholder="Enter Vehicle Number" required-->
					  <select  name="vehicle_no" class="form-control" required>
						...
						<option value="{{$dat->v_id}}" >{{$dat->vehicle_no}}</option>
							@endforeach
						@endif
					 </select>
                  </div>
                  ...
                  <div class="col-sm-9">
                     <input name="code" class="form-control" type="text" placeholder="Enter Code" required>
					 
                  </div>
                </div><div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">Route Start Place<span>*<span></label>
                  <div class="col-sm-9">
                     <input name="start" class="form-control" type="text" placeholder="Enter Route Start Place " required>
					 
                  </div>
                </div><div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">Route Stop Place<span>*<span></label>
                  <div class="col-sm-9">
                     <input name="stop" class="form-control" type="text" placeholder="Enter Route Stop Place " required>
