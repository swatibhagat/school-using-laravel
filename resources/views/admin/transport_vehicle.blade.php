					...
					<div class="box-body">
						<table id="memTable" class="table table-bordered table-striped">
							...
							<tr>								
								...
								<td>{{$vehicle->vehicle_seat}}</td>
								<td>{{$vehicle->max_allow}}</td>
								<td>{{$vehicle->contact_person}}</td>
								<td><a class="icon-pencil" title="" href="{{url("/vehicle/edit/$vehicle->v_id")}}"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
								 
								<a class="icon-cross2" onclick="return confirmDel()" title="" href="{{url("/vehicle/delete/$vehicle->v_id")}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
							</tr>  
							@endforeach	
							@endif						
							</tbody> 
