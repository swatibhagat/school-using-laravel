			...
			<form class="form-horizontal" method="post" action="create" >					 
			   ...
			   <div class="box box-primary box-body -border-bottom -margin-top-twentyfive">                 
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="sub_code" class="form-control" type="text" placeholder="Enter Subject Code" required>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="sub_name" class="form-control" type="text" placeholder="Enter Subject Name" required>
