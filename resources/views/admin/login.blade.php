...
<head>
  ...
  <title>Zurich School Industries | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset("/resources/assets/admin-lte/plugins/iCheck/square/blue.css") }}">
...
<div class="login-box Absolute-Center">

  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">  <div class="login-logo">
    <a href="javascript:void(0);"><b>
      <img src="{{ asset("/resources/assets/admin-lte/dist/img/zi 9.png") }}" class="-full-width"></b></a>
  </div></p>
...
<script src="{{ asset("/resources/assets/admin-lte/plugins/iCheck/icheck.min.js") }}"></script>
 <link rel="stylesheet" href="{{ asset("/resources/assets/admin-lte/dist/css/style.css") }}"> 
<script>
  $(function () {
    $('input').iCheck({
