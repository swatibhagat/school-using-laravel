			...
			<form class="form-horizontal" method="post" action="update" >					 
			   ...
			   <div class="box box-primary box-body -border-bottom -margin-top-twentyfive">                 
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="category" class="form-control" type="text" placeholder="Enter Student Category" value="{{$category->stu_category}}" required>
					 
                  </div>
                </div>
					 <input type="hidden" name="token" value="{{ $category->stu_id }}" />
					@endforeach
				@endif
			<div>	
              <!-- /.box-body -->
