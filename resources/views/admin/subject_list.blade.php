					...
					<div class="box-body">
						<table id="memTable" class="table table-bordered table-striped">
							...
							<tr>								
								...
								<td><a class="icon-pencil" title="" href="{{url("/subject/edit/$Subject->id")}}"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
								 
								<a class="icon-cross2" onclick="return confirmDel()" title="" href="{{url("/subject/delete/$Subject->id")}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
							</tr>  
							@endforeach	
							@endif						
							</tbody> 
