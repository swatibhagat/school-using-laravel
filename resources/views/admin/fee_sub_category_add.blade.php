		...
		<div class="row">			 
			...
			<form class="form-horizontal" method="post" action="create" >					 
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <input name="fee_sub_cat" class="form-control" type="text" placeholder="Enter Fee Sub Category" required>
					 
                  </div>
                </div><div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">Amount <span>*<span></label>
                  <div class="col-sm-9">
                     <input name="amount" class="form-control" type="text" placeholder="Enter Fee Amount" required>
